...
<header>
  ...
  <div class="flex justify-between items-center py-6 px-10 container mx-auto">
    ...
    <div>
      <h1 class="text-2xl font-bold bg-gradient-to-tr from-indigo-600 to-green-600 bg-clip-text text-transparent hover:cursor-pointer">luxShoes</h1>
    </div>
    ...
    <div>
      ...
      <div class="flex items-center">
        ...
        <ul class="sm:flex space-x-4 hidden items-center">
          <li><a href="#" class="text-gray-700 hover:text-indigo-600 text-md "><NavLink to={'/about'}>About</NavLink></a></li>
...
<main>
  ...
  <section>
    <div class="bg-gray-100 sm:grid grid-cols-5 grid-rows-1 px-4 py-6  space-y-6 sm:space-y-0 sm:gap-4">
    ...
    <div class="h-96 col-span-4 bg-gradient-to-tr from-indigo-800 to-indigo-500 rounded-md flex items-center">
      ...
      <p class="text-indigo-100 mt-4 capitalize font-thin tracking-wider leading-7">Добро пожаловать в наш интернет-магазин обуви! Мы рады приветствовать вас на странице, где вы сможете найти самую стильную и комфортную обувь на рынке.</p>
